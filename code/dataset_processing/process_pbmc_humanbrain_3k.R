...
counts <- Read10X_h5("~/Data/pbmc_humanbrain_3k/human_brain_3k_filtered_feature_bc_matrix.h5")
fragments <- "~/Data/pbmc_humanbrain_3k/human_brain_3k_atac_fragments.tsv.gz"
...
# write peaks to file
write.table(x = as.data.frame(peaks), file = "~/Data/pbmc_humanbrain_3k/pbmc_humanbrain_3k_peaks.tsv", sep = "\t", quote = FALSE, row.names = FALSE)
